...
- [ ] P5-06 Publish verified GitHub Releases and add tested Homebrew plus
  ...
  `SHA256SUMS`; exact metadata is now published in the selected Homebrew and
  Scoop repositories. Native clean-machine package evidence remains open, and
  winget is deferred pending a generated manifest and demand evidence.

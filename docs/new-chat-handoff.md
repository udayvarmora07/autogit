...
- Tracker: 96 total checklist rows, 68 checked, 28 open.
...
- Those earlier packages occupy 11 checklist rows because P5-01 has two
  independent substeps. P5-01 and P5-02 are accepted for the bounded
  private-alpha scope under the documented owner-review exception; the eight
  P4 release rows stay open pending exact-tag hosted acceptance. The full
  project still has 28 open rows.
...
distinct exact-tag requirement for P4-08.

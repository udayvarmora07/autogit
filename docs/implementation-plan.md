...
5. P5-03 and P5-04 now have a local implementation in
   ...
   review, and consumer verification of the resulting attestations. P5-05
   through P5-07 remain open: independent reproducibility, verified package
   channels, and native install/rollback drill evidence are not complete.

...
var controls = []control{
	...
	{ID: "P4-06", Status: "implemented", Requirements: []string{"FR-GIT-001", "FR-PUB-001"}, Tests: []string{"TestScenarioEvaluationGradesFinalRepositoryState"}, Commands: []string{"bash scripts/scenario-eval.sh --binary PATH", "go test ./scripts -run TestScenarioEvaluation"}, Threats: []string{"GATE-003", "GATE-005"}},
